...
class Stats {
  @ApiProperty({
    description:
      'Number of results found for this search, not all results may show',
  })
  total: number;
...
class DeepLink {
  @ApiProperty({
    description:
      'Url straight to the booking page of this deal so the price can be retrieved and booked',
  })
  link: string;
...
class Flight {
  ...
  @ApiProperty({
    isArray: true,
    description:
      'details on each agent prices and url links to the booking for quick access',
  })
  deals: Deal;
...
export class Search {
  ...
  @ApiProperty({
    isArray: true,
    description:
      'Array with all the flights found, limited to a few cheapest flights',
  })
  flights: Flight;
  ...
  @ApiProperty({
    description:
      'Searh url for search on website so you can see all other flight details related to this search',
  })
  searchUrl: Stats;
}
...
export class SearchDescription {
  @ApiProperty({
    description:
      'Description of your flight options with flight details or info to help you explore anywhere',
  })
  search: string;
}
